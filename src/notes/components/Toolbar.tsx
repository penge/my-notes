...
const Toolbar = ({ os }: ToolbarProps): h.JSX.Element => {
  const getTitle = useCallback((key: string) => os && titles[key][os], [os]);
  ...
  return (
    <Fragment>
      <div id="toolbar" class="bar">
        ...
        <div id="H" class={clsx("button", submenu === "H" && "active")} title="Heading" onClick={toggleSubmenu}>
          ...
          <div class="menu bar">
            <div id="H1" class="button" title="Heading 1" onClick={commands.h1}>H<span>1</span></div>
            <div id="H2" class="button" title="Heading 2" onClick={commands.h2}>H<span>2</span></div>
            <div id="H3" class="button" title="Heading 3" onClick={commands.h3}>H<span>3</span></div>
          </div>
        </div>

        <div id="UL" class="button" title={getTitle("UL")} onClick={commands.ul}>
        ...
        <div id="OL" class="button" title={getTitle("OL")} onClick={commands.ol}>
        ...
        <div id="OUTDENT" class="button" title="Outdent" onClick={commands.outdent}>
        ...
        <div id="INDENT" class="button" title="Indent" onClick={commands.indent}>
          <svg viewBox="0 0 24 24">
        ...
        <div id="CL" class="button" title="Align Left" onClick={commands.left}>
        ...
        <div id="CC" class="button" title="Align Center" onClick={commands.center}>
          <svg viewBox="0 0 397.061 397.061">
        ...
        <div id="CR" class="button" title="Align Right" onClick={commands.right}>
          <svg viewBox="0 0 397.061 397.061">
        ...
        <div id="IMG" class="button" title="Insert Image" onClick={() => {
          range.save();
        ...
        <div id="LINK" class="button" title="Insert Link" onClick={() => {
          range.save();
        ...
        <div id="PRE" class="button" title="Code Block" onClick={commands.pre}>
        ...
        <div id="TABLE" class={clsx("button", submenu === "TABLE" && "active")} title="Table" onClick={toggleSubmenu}>
          ...
          <div class="menu bar">
            <div id="TABLE_INSERT" class="button wide" title="Insert table" onClick={() => commands.table.insertTable(callback)}>
              <svg viewBox="0 0 384 384">
                <path d="M0,0v384h384V0H0z M170.667,341.333h-128v-128h128V341.333z M170.667,170.667h-128v-128h128V170.667z M341.333,341.333
                  h-128v-128h128V341.333z M341.333,170.667h-128v-128h128V170.667z"/>
              </svg>
            </div>
            <div id="TABLE_ROW_ABOVE" class="button" title="Insert row above" onClick={() => commands.table.insertRowAbove(callback)}>
            ...
            <div id="TABLE_ROW_BELOW" class="button" title="Insert row below" onClick={() => commands.table.insertRowBelow(callback)}>
              <svg viewBox="0 -21 512 512">
            ...
            <div id="TABLE_COLUMN_LEFT" class="button" title="Insert column left" onClick={() => commands.table.insertColumnLeft(callback)}>
            ...
            <div id="TABLE_COLUMN_RIGHT" class="button wide" title="Insert column right" onClick={() => commands.table.insertColumnRight(callback)}>
              <svg viewBox="-21 0 512 512">
            ...
            <div id="TABLE_HEADING_ROW" class="button" title="Toggle heading row" onClick={() => commands.table.toggleHeadingRow(callback)}>
            ...
            <div id="TABLE_HEADING_COLUMN" class="button wide rotate90" title="Toggle heading column" onClick={() => commands.table.toggleHeadingColumn(callback)}>
              <svg viewBox="0 0 485.064 485.064">
                <path d="M458.736,181.097H26.334C11.793,181.097,0,192.884,0,207.425v70.215c0,14.541,11.787,26.328,26.334,26.328h432.402
                  c14.541,0,26.328-11.787,26.328-26.328v-70.215C485.07,192.884,473.283,181.097,458.736,181.097z"/>
              </svg>
            </div>
            <div id="TABLE_DELETE_ROW" class="button" title="Delete row" onClick={() => commands.table.deleteRow(callback)}>
            ...
            <div id="TABLE_DELETE_COLUMN" class="button" title="Delete column" onClick={() => commands.table.deleteColumn(callback)}>
        ...
        <div id="HIGH" class="button" title="Highlight" onClick={() => commands.highlight(callback)}>
          <svg viewBox="0 0 512 512">
        ...
        <div id="RF" class="button" title={getTitle("RF")} onClick={commands.removeFormat}>
          <svg viewBox="0 0 384 384">
