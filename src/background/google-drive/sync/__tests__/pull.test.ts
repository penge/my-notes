...
*/
  ...
  const files = [
    ...
    },
    {
      ...
      name: "Books",
      createdTime: "2020-04-20T09:04:00Z",
      modifiedTime: "2020-04-20T09:04:09Z",
    },
    {
      id: "df29",
      name: "Amazon", // before "Shopping"
      createdTime: "2020-04-20T09:06:00Z",
      modifiedTime: "2020-04-20T09:06:11Z",
    },
    {
      id: "777f",
      name: "Math", // name conflict = add content to existing note
      createdTime: "2020-04-20T09:25:00Z",
      modifiedTime: "2020-04-20T09:25:25Z",
    },
    {
      id: "9e0e",
      name: "Trip", // before "Vacation"
      createdTime: "2020-04-20T09:10:00Z",
      modifiedTime: "2020-04-20T09:10:15Z",
    },
    ...
    // NEW
    {
      id: "2b18",
      name: "Phones",
      createdTime: "2020-04-20T09:11:00Z",
      modifiedTime: "2020-04-20T09:11:11Z",
    },
    {
      id: "0dc9",
      name: "TV",
      createdTime: "2020-04-20T09:12:00Z",
      modifiedTime: "2020-04-20T09:12:12Z",
    },
    {
      id: "b378",
      name: "Lamps",
      createdTime: "2020-04-20T09:13:00Z",
      modifiedTime: "2020-04-20T09:13:13Z",
    },
  ];
...
it("links notes to files with same name in Google Drive", async () => {
  ...
  const files = [
    ...
    // UPDATED
    {
      ...
      name: "Clipboard",
      createdTime: "2020-04-20T09:07:00Z",
      modifiedTime: "2020-04-20T09:07:12Z",
    },
  ];
...
it("links notes to the last file in Google Drive if having the same name in Google Drive", async () => {
  ...
  const files = [
    // "Todo" renamed to "Clipboard" (UPDATED)
    {
      ...
      name: "Clipboard",
      createdTime: "2020-04-20T09:02:00Z",
      modifiedTime: "2020-04-20T09:07:17Z",
    },
...
it("renames the note if linked but renamed in Google Drive", async () => {
  ...
  const files = [
    // UPDATED, renamed as well
    {
      ...
      name: "Recipes",
      createdTime: "2020-04-20T09:03:00Z",
      modifiedTime: "2020-04-20T09:03:13Z",
    },
  ];
